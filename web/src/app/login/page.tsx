      ...
      >
        ...
        <div className="w-full md:w-5/12 bg-gradient-to-br from-blue-600 to-indigo-700 p-10 md:p-12 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            >
              Hệ thống quản lý, giám sát và phân tích báo cáo đồ thị mã nguồn
              tiên tiến nhất dành cho team phát triển.
            </motion.p>
          </div>
        ...
        <div className="w-full md:w-7/12 p-10 md:p-16 lg:p-20 flex flex-col justify-center bg-white/40">
          <div className="max-w-sm w-full mx-auto">
            <div className="mb-10">
              <h2 className="text-2xl font-sans text-slate-800 mb-2">
                Chào mừng trở lại! 👋
              </h2>
              <p className="text-slate-500 text-sm font-medium">
                Vui lòng đăng nhập để tiếp tục truy cập vào hệ thống báo cáo.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5 group">
                <label className="text-xs font-bold text-slate-600 uppercase tracking-wide ml-1 transition-colors group-focus-within:text-blue-600">
                  Tài khoản
                </label>
              ...
              <div className="space-y-1.5 group">
                <div className="flex items-center justify-between ml-1">
                  <label className="text-xs font-bold text-slate-600 uppercase tracking-wide transition-colors group-focus-within:text-blue-600">
                    Mật khẩu
                  </label>
                  <a
                    href="#"
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              <a
                ...
                target="_blank"
                className="flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm hover:shadow-md"
              >
