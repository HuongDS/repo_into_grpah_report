...
const navLinks = [
  { href: "/", label: "Trang chủ", icon: LayoutDashboard },
  {
    ...
    subItems: [
      {
        href: "/reports/Question_Evaluate",
        label: "Đánh giá câu hỏi",
        icon: CheckCircle,
      },
      {
        href: "/reports/Question_Generate",
        label: "Tạo câu hỏi",
        icon: Sparkles,
      },
      {
        href: "/reports/Analyze_Source",
        label: "Phân tích nguồn",
        icon: PieChart,
      },
      {
        href: "/reports/Solution_Report",
        label: "Báo cáo giải pháp",
        icon: Lightbulb,
      },
    ],
  },
  ...
  return (
    ...
    >
      ...
      <SidebarContent className="px-2 mt-4 custom-scrollbar">
        <SidebarGroup>
          <SidebarGroupLabel className="text-xs font-semibold text-slate-500 mb-2 group-data-[collapsible=icon]:hidden">
            Menu chính
          </SidebarGroupLabel>
          <SidebarGroupContent>
